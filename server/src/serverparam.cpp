...
const int ServerParam::HALF_TIME = 200;
const int ServerParam::DROP_TIME = 100;

const double ServerParam::PITCH_LENGTH = 45.0;
const double ServerParam::PITCH_WIDTH = 28.0;
const double ServerParam::PITCH_MARGIN = 5.0;
const double ServerParam::CENTER_CIRCLE_R = 9.0;
const double ServerParam::PENALTY_AREA_LENGTH = 9;
const double ServerParam::PENALTY_AREA_WIDTH = 18;
const double ServerParam::GOAL_AREA_LENGTH = 3;
const double ServerParam::GOAL_AREA_WIDTH = 6;
...
const int ServerParam::NR_NORMAL_HALFS = 1;
const int ServerParam::NR_EXTRA_HALFS = 0;
const bool ServerParam::PENALTY_SHOOT_OUTS = false;
