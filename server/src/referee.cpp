...
TouchRef::checkGoal()
{
    ...
    double r = 3.0;
    PVector vecyvecyball(M_stadium.ball().pos().x,M_stadium.ball().pos().y);
    PVector pointr(22.5,0);
    bool checkingoalr = pointr.distance2(vecyvecyball) <= r * r ;
    PVector pointl(-22.5,0);
    bool checkingoall = pointl.distance2(vecyvecyball) <= r * r ;
    if(checkingoalr )
    {
